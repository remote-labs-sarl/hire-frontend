        ...
        <div className="footer">
            <Container>
                ...
                <div className="row pt-3 pb-3 d-flex align-items-center ">
                    ...
                    <div
                        className="col-12 col-lg-6 col-xl-6 justify-content-between   align-content-center text-center d-flex gap-5">
                        <div className="align-self-start">Termes Conditions</div>
                        <div className="align-self-end">Confidentialite</div>
                    </div>
